    ...
    def shipPlace(self, ship) # 
        ...
        while (shipPlaced == False)
            ...
            if (self.board.placeShip("up", ship, x, y))
                shipPlaced == True
            else if (self.board.placeShip("down", ship, x, y))
                shipPlaced == True
            else if (self.board.placeShip("left", ship, x, y))
                shipPlaced == True
            else if (self.board.placeShip("right", ship, x, y))
                shipPlaced == True
            else:
                pass
    def shipGuess(self)
